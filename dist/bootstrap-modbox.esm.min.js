...
export default class modbox{static version="1.3.0";#options;#modal;#modalEl;#footer;static#defaultOptions={...bootstrap.Modal.Default,icon:null,style:"white",titleStyle:null,title:"Information",body:"",message:"",size:null,center:!1,fade:!0,show:!1,relatedTarget:void 0,scrollable:!0,destroyOnClose:!1,defaultButton:!0,swapButtonOrder:!1,justifyButtons:null,events:{},buttons:[],okButton:{label:"OK",style:"primary"},closeButton:{label:"Cancel",style:"secondary"},input:{type:"text",class:"",value:"",title:null,placeholder:null,autocomplete:"off",minlength:null,maxlength:null,pattern:null,required:!1,sanitizer:!1},sanitizer:modbox.#sanitizeString};static#defaultButtonOptions={label:"Close",style:"secondary",class:"",outline:!1,size:null,icon:null,title:null,disabled:!1,close:!0,callback:null};static#getUID(t="modbox-"){return t+Math.floor(1e6*Math.random())}static#typeof(t){return"object"==typeof t?Object.prototype.toString.call(t).slice(8,-1).toLowerCase():typeof t}static#deepMerge(i,n){const s={...i,...n};return Object.keys(s).forEach(t=>{var o=i[t],e=n[t];"object"===modbox.#typeof(o)&&"object"===modbox.#typeof(e)&&(s[t]=modbox.#deepMerge(o,e))}),s}static#checkUserOptions(t){return"string"==typeof t?{body:t}:t}static#sanitizeString(t=""){return t}static#buildPromiseModal(l={},d="alert"){return l={...l,destroyOnClose:!0,defaultButton:!1,buttons:[]},new Promise((n,t)=>{const s=new modbox(l),o=[l.closeButton];if(["confirm","prompt"].includes(d)){let i=()=>n();if("prompt"===d&&"object"===modbox.#typeof(l.input)){let e=!1;(!0===l.input.required||"number"==typeof l.input.minlength||"string"==typeof l.input.pattern&&l.input.pattern.length)&&(l.okButton.close=!1,e=!0),i=()=>{const t=s.modalEl.querySelector(`#${l.input.id}`);if(!0!==e||t.reportValidity()){const o="function"==typeof s.options.input.sanitizer?s.options.input.sanitizer:!0===s.options.input.sanitizer?s.options.sanitizer:modbox.#sanitizeString;n(o(t.value)),s.hide()}}}o.unshift({...l.okButton,callback:function(t,o){"function"==typeof l.okButton.callback&&l.okButton.callback.call(this,t,o),i()}})}const[e]=o.map(t=>s.addButton(t));"prompt"===d&&"object"===modbox.#typeof(l.input)&&s.modalEl.querySelector(`#${l.input.id}`).addEventListener("keyup",t=>{"Enter"===t.key&&e.click()}),s.addEvent("hide",()=>{"alert"===d?n():["confirm","prompt"].includes(d)&&document.activeElement!==e&&t()}),s.show()})}#buildModal(){var t=["primary","secondary","success","danger","dark","body"].includes(this.#options.style),o=this.#options.titleStyle||(t?"white":"dark");let e="";this.#options.title&&(e=`
			...
			`.trim()),modbox.container.insertAdjacentHTML("beforeend",this.#options.sanitizer(`
