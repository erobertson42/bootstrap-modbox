...
export default class modbox{static version="1.2.1";#options;#modal;#modalEl;#footer;static#defaultOptions={...bootstrap.Modal.Default,icon:null,style:"white",titleStyle:null,title:"Information",body:"",message:"",size:null,center:!1,fade:!0,show:!1,relatedTarget:void 0,scrollable:!0,destroyOnClose:!1,defaultButton:!0,swapButtonOrder:!1,justifyButtons:null,events:{},buttons:[],okButton:{label:"OK",style:"primary"},closeButton:{label:"Cancel",style:"secondary"},input:{type:"text",class:"",value:"",title:null,placeholder:null,autocomplete:"off",minlength:null,maxlength:null,pattern:null,required:!1}};static#defaultButtonOptions={label:"Close",style:"secondary",class:"",outline:!1,size:null,icon:null,title:null,disabled:!1,close:!0,callback:null};static#getUID=(t="modbox-")=>t+Math.floor(1e6*Math.random());static#typeof=t=>"object"==typeof t?Object.prototype.toString.call(t).slice(8,-1).toLowerCase():typeof t;static#deepMerge=(i,s)=>{const n={...i,...s};return Object.keys(n).forEach(t=>{var o=i[t],e=s[t];"object"===modbox.#typeof(o)&&"object"===modbox.#typeof(e)&&(n[t]=modbox.#deepMerge(o,e))}),n};static#checkUserOptions=t=>"string"==typeof t?{body:t}:t;static#buildPromiseModal=(n={},l="alert")=>(n={...n,destroyOnClose:!0,defaultButton:!1,buttons:[]},new Promise((i,t)=>{const s=new modbox(n),o=[n.closeButton];if(["confirm","prompt"].includes(l)){let e=()=>i();if("prompt"===l&&"object"===modbox.#typeof(n.input)){let o=!1;(!0===n.input.required||"number"==typeof n.input.minlength||"string"==typeof n.input.pattern&&n.input.pattern.length)&&(n.okButton.close=!1,o=!0),e=()=>{const t=s.modalEl.querySelector(`#${n.input.id}`);!0===o&&!t.reportValidity()||(i(t.value),s.hide())}}o.unshift({...n.okButton,callback:function(t,o){"function"==typeof n.okButton.callback&&n.okButton.callback.call(this,t,o),e()}})}const[e]=o.map(t=>s.addButton(t));"prompt"===l&&"object"===modbox.#typeof(n.input)&&s.modalEl.querySelector(`#${n.input.id}`).addEventListener("keyup",t=>{"Enter"===t.key&&e.click()}),s.addEvent("hide",()=>{"alert"===l?i():["confirm","prompt"].includes(l)&&document.activeElement!==e&&t()}),s.show()}));#buildModal=()=>{var t=["primary","secondary","success","danger","dark","body"].includes(this.#options.style),o=this.#options.titleStyle||(t?"white":"dark");let e="";this.#options.title&&(e=`
